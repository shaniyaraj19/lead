            ...
            <div className="space-y-10 mt-8">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  At V-Accel, the security and privacy of your data is our highest priority. Thousands
                  of businesses trust us with sensitive customer and sales information, and we take that
              ...
              <div>
                ...
                <ul className="list-disc pl-6 text-gray-400 mb-2">
                  <li>
                    <span className="font-semibold text-white">Data Encryption:</span> All data is encrypted in transit (using TLS 1.2+) and at rest using modern encryption standards.
                  </li>
                  <li>
                    <span className="font-semibold text-white">Secure Data Centers:</span> We host our infrastructure on trusted cloud providers like AWS, Google Cloud, or Azure, certified under ISO 27001, SOC 1/2, and PCI DSS.
                  </li>
                  <li>
                    <span className="font-semibold text-white">Regular Backups:</span> We perform automated daily backups for disaster recovery.
                  </li>
                  <li>
                    <span className="font-semibold text-white">Network & Application Security:</span> We use firewalls, intrusion detection, and patch systems regularly.
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-3">Strict Access Controls</h2>
                <ul className="list-disc pl-6 text-gray-400 mb-2">
                  <li>Only authorized team members have access to production systems using least privilege.</li>
                  <li>All access is logged and monitored continuously.</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 text-gray-400 mb-2">
                  <li>Our engineers follow secure coding practices.</li>
                  <li>All code changes are reviewed and tested before deployment.</li>
                  <li>We monitor and log activity to detect threats early.</li>
                </ul>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-3">Compliance & Data Privacy</h2>
                <ul className="list-disc pl-6 text-gray-400 mb-2">
                  <li>We are GDPR-compliant and help customers stay compliant.</li>
                  <li>We only process data essential to service delivery and never sell your data.</li>
                </ul>
                <p className="text-gray-300">
                  For more, see our{' '}
              ...
              <div>
                ...
                <p className="text-gray-300 mb-2">
                  We value community support in keeping our systems secure. If you discover a vulnerability, please contact us immediately at{' '}
                  <a href="mailto:security@v-accel.ai" className="text-purple-400 underline">security@v-accel.ai</a>.
                </p>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-3">Questions?</h2>
                <p className="text-gray-300 mb-2">
                  If you'd like to know more about how we protect your data, contact us:
                </p>
                <ul className="list-none pl-0 text-gray-400">
                  <li>
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-3">Additional Information</h2>
                <ul className="list-disc pl-6 text-gray-400 mb-2">
                  <li>External penetration test summaries available upon request.</li>
                  <li>We provide SLA-based uptime guarantees for enterprise customers.</li>
                  <li>Data is retained only as long as necessary or required by law.</li>
                  <li>Real-time system status transparency (if a status page is available).</li>
                </ul>
              </div>
            </div>
          </div>
