...
//                 className="w-full max-w-xl px-6 py-4 bg-gray-900 border border-gray-700 rounded-l-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-base"
//               />
//               <button className="px-6 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-r-xl transition-colors duration-300 text-base">
//                 Search
//               </button>
//             </motion.div>
//           </div>
...
//                 viewport={{ once: true }}
//               >
//                 <h2 className="text-2xl font-bold text-white mb-4">{topic.category}</h2>
...
const HelpCenter = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero / Search Section */}
        <section className="bg-gradient-to-br from-gray-900 via-black to-gray-800 flex items-center justify-center pt-40 pb-20">
